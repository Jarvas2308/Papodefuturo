  ...
  (
    ...
    return (
      <button
        ...
        type={type}
        className={cn(
          'inline-flex items-center justify-center gap-2 rounded-[var(--radius-md)] border text-sm font-semibold transition-colors outline-none',
          'focus-visible:ring-2 focus-visible:ring-[var(--color-ring)] focus-visible:ring-offset-2',
          'disabled:cursor-not-allowed disabled:opacity-60',
          variant === 'primary' &&
            'border-[var(--color-brand)] bg-[var(--color-brand)] px-4 py-2.5 text-white hover:bg-[var(--color-brand-strong)]',
          variant === 'secondary' &&
